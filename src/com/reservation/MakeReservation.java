...
public class MakeReservation extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int guest_id = 0;
		int travel_id = 0;
		int art_id=(int)hs.getAttribute("art_id");
		...
		try {
			...
			if (rs.next()) {
				...
				int loadReservationDate = statement.executeUpdate("insert into travel values('" + travel_id + "','"+ oldDate + "','" + day + "','" + newDate + "','" + Status + "','" + guestId + "','"+art_id+"',0,0,0)");
