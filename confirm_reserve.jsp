...
<body>
	...
	<div class="container-fluid">
		<div class="navbar-header">
			<a class="navbar-brand"> Pick your art</a>
		</div>
	</div>
	</nav>
	<div class="container-fluid">
			...
			<div class="panel-body">
				<div class="container-fluid">
					<ul class="nav nav-pills">
						...
						<li class="active"><a href="index.jsp">Order</a></li>
								...
								<div class="panel panel-default">
									<div class="panel-body">
										<form method="post" action="confirm_reserve_process.jsp">
											...
											<div class="form-group" style="float: left;">
												<label>Art Type</label> <br /> <input type="text"
													value="<%=resultset.getString(16)%>" class="form-control"
													size="20" disabled="disabled" />
											</div>
											<div class="form-group"
												style="float: left; margin-left: 20px;">
												<label>Piece</label> <br /> <input type="number" name="piece"
													value="<%=resultset.getInt(5)%>" class="form-control"
													readonly />
											</div>
											<%
												}
											...
											<div class="form-group"
												style="float: left; margin-left: 20px;">
												<label>Extra Art</label> <br /> <input type="number"
													min="0" max="99" name="extra_art" class="form-control" />
											</div>
											<div class="form-group"
												style="float: left; margin-left: 20px;">
												<label style="color: #ff0000;">*Extra Art cost 800</label>
											</div>
											<br style="clear: both;" /> <br />
