...
<body>
	...
	<ul id = "menu">
		...
		<li><a href = "reservation.jsp">Make Order</a></li> |
	...
	<div id="myCarousel" class="carousel slide container-fluid" data-ride="carousel">
		...
		<div style = "margin:auto;" class="carousel-inner" role="listbox">
			<div class="item active">
				<img src="images/pen.jpg" style = "width:100%; height:450px;" />
			</div>
		
			<div class="item">
				<img src="images/colo.jpg" style = "width:100%; height:450px;"  />
			</div>
		
			<div class="item">
				<img src="images/cha.jpg" style = "width:100%; height:450px;" />
			</div>
		
			<div class="item">
				<img src="images/digi.jpg" style = "width:100%; height:450px;" />
			</div>
			...
			<div class="item">
				<img src="images/art.jpg" style = "width:100%; height:450px;" />
			</div>
			
			<div class="item">
				<img src="images/art2.jpg" style = "width:100%; height:450px;" />
			</div>
