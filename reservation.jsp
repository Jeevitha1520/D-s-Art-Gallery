	...
	<div style = "margin-left:0;" class = "container">
		<div class = "panel panel-default" style="width:1320px;">
			<div class = "panel-body">
				<strong><h3>Make Order</h3></strong>
				<%
				...
				%>
					<div class = "well" style = "height:300px; width:100%;">
						...
						<div style = "float:left; margin-left:10px;">
							...
							<h4 style = "color:#00ff00;">Price:&nbsp;<%=resultset.getString(3)%>&nbsp;Rs/</h4>
							<br /><br /><br /><br /><br /><br />
							<a style = "margin-left:580px;" href = "add_reserve.jsp?art_id=<%=resultset.getInt(1) %>" class = "btn btn-info"><i class = "glyphicon glyphicon-list"></i> Order</a>
						</div>
					</div>
				<%
					}
